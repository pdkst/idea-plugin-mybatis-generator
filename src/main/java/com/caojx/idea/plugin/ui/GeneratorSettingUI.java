...
//            resetPackageAndPathTableData();
    ...
    private List<TableInfo> getTables(DatabaseSensitiveProperties database, Set<String> tableNames) {
        // 转换为jdbcType, clazz
        final Map<String, String> jdbcTypeMappingMap = globalPersistentStateService.getState().getCustomerJdbcTypeMappingMap();
     ...
     * 刷新数据库下拉框
     */
    public void refreshDatabaseComBox(List<DatabaseProperties> databases) {
